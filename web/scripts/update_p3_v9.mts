...
console.log("\nKey changes vs v8:");
console.log("  - 出力ルール: full rewrite — only narration text + pause tags allowed");
console.log("  - Pause tags: 15-20 → 10-15, added 使いすぎ禁止 rule");
console.log("  - Removed ━━━ section headers (were being echoed as output)");
console.log("  - 文字数報告 explicitly banned from output");
process.exit(0);
