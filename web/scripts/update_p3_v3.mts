...
【出力前チェック（必須）】
- 総文字数：1700〜2200文字の範囲内か？（1700文字未満なら加筆してから出力）
...
console.log("\nKey changes:");
console.log("  - 出力ルール: no preamble, no title line after 総文字数");
console.log("  - 文字数: 2200〜2800 → 1700〜2200文字");
console.log("  - 時間: 8〜10分 → 6〜8分 (−20%)");
process.exit(0);
