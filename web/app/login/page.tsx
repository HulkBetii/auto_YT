export default async function LoginPage({
  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-zinc-50 dark:bg-black">
      ...
      >
        <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50">哲人の刻 — Dashboard</h1>
        ...
        {error && <p className="text-sm text-red-600">Sai mật khẩu. Vui lòng thử lại.</p>}
        <button
          type="submit"
